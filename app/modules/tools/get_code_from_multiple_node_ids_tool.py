...
class GetCodeFromMultipleNodeIdsTool:
    ...
    description = """Retrieves code and docstring for multiple nodes in a project.
...
def get_code_from_multiple_node_ids_tool(
    ...
    return StructuredTool.from_function(
        ...
        name="Get Code and docstring From Multiple Node IDs",
        description="""Retrieves code and docstring for multiple node ids in a project given their node IDs
